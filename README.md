...
| **[Assistant](https://abx-git.github.io/blueprint-pattern.github.io/)** | Adoption guide for architects — scope, setup, workflows ([Pages repo](https://github.com/abx-git/blueprint-pattern.github.io)) |
