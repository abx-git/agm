...
| **[Assistant](https://abx-git.github.io/blueprint-pattern.github.io/)** | Guided Notebook — adopt pattern, copy workflows ([Pages repo](https://github.com/abx-git/blueprint-pattern.github.io)) |
