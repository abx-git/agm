...
if [[ "$ADD_MISSING" -eq 1 ]]; then
  ...
  fetch_if_missing "docs/templates/architecture/process/README.md" "${DOC_ROOT}process/README.md"
  fetch_if_missing "docs/templates/architecture/process/spikes/README.md" "${DOC_ROOT}process/spikes/README.md"
  fetch_if_missing "docs/templates/architecture/process/spikes/_template/index.md" "${DOC_ROOT}process/spikes/_template/index.md"
  fetch_if_missing "docs/templates/architecture/process/spikes/_template/notes.md" "${DOC_ROOT}process/spikes/_template/notes.md"
  fetch_if_missing "docs/templates/architecture/process/spikes/_template/boards/README.md" "${DOC_ROOT}process/spikes/_template/boards/README.md"
  fetch_if_missing "docs/templates/architecture/process/reviews/README.md" "${DOC_ROOT}process/reviews/README.md"
  fetch_if_missing "docs/templates/architecture/process/reviews/_template/index.md" "${DOC_ROOT}process/reviews/_template/index.md"
  fetch_if_missing "docs/templates/architecture/process/reviews/_template/report.md" "${DOC_ROOT}process/reviews/_template/report.md"
  fetch_if_missing "docs/templates/architecture/process/reviews/_template/findings.md" "${DOC_ROOT}process/reviews/_template/findings.md"
  if [[ "$INSTALL_DOMAIN" -eq 1 ]]; then
