...
2. **Activate a workflow** (session prompt): see [prompts/README.md](../prompts/README.md) — e.g. `./scripts/bp-workflow.sh checkout maintenance` or paste from [prompts/workflows/maintenance.md](../prompts/workflows/maintenance.md).
