...
If the session prompt includes **Documentation focus (bootstrap)**, extend `blueprint.md` with phase rows and stubs for each selected focus (see [doc-extensions.md](./doc-extensions.md)). Do not skip focus items the human selected.
